...
export default function EmployersPage() {
  return (
    <>
      <section className="mx-auto w-full max-w-6xl px-4 pb-4 pt-10 sm:px-6 md:px-8 md:pb-5 md:pt-14">
      ...
      <section className="mx-auto w-full max-w-6xl px-4 pb-8 pt-0 sm:px-6 md:px-8 md:pb-10">
