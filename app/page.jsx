...
export default function HomePage() {
  return (
    <>
      <section className="section-wrap pb-8 md:pb-10">
        <div className="grid gap-6 md:grid-cols-[1.1fr_0.9fr] md:items-center md:gap-6">
          <div>
          ...
          <div className="grid gap-2.5 sm:grid-cols-2 sm:grid-rows-2">
      ...
      <section className="mx-auto w-full max-w-6xl px-4 pb-6 sm:px-6 md:px-8 md:pb-8">
        <div className="panel p-6 md:p-8">
          <p className="text-center text-sm font-semibold uppercase tracking-[0.2em] text-cyan-200">Role Coverage</p>
          <div className="mt-4 grid grid-cols-2 gap-2.5 sm:grid-cols-3 lg:grid-cols-4">
            {specialties.map((item) => (
              <span
                key={item}
                className="inline-flex min-h-[44px] items-center justify-center rounded-full border border-white/15 bg-white/5 px-3.5 py-2 text-center text-xs font-medium text-slate-100 sm:px-4 sm:text-sm"
              >
                {item}
              </span>
            ))}
      ...
      <section className="mx-auto w-full max-w-6xl px-4 pb-5 sm:px-6 md:px-8 md:pb-6">
        <div className="grid gap-3 md:grid-cols-3">
          {stats.map((stat) => (
            <div key={stat.label} className="panel p-5 md:p-6">
      ...
      <section className="mx-auto w-full max-w-6xl px-4 pb-10 sm:px-6 md:px-8 md:pb-12">
