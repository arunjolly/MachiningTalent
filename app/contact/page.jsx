export default function ContactPage() {
  return (
    <section className="section-wrap">
      ...
      <h1 className="mt-4 font-[var(--font-space)] text-4xl font-bold text-white md:text-5xl">Book a call with Machining Talent.</h1>
      ...
      <div className="mt-8 grid gap-5 md:grid-cols-2">
        <div className="panel p-6">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="mt-5 inline-flex rounded-full bg-spark-500 px-5 py-2.5 text-sm font-bold text-white hover:bg-spark-600"
          >
            Book a Call
          </a>
        </div>
